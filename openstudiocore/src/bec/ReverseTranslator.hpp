...
namespace bec {
  ...
  public:
    ...
    // If masterAutosize = true the translator will ignore choices in the bec file and forcibly autosize the entire model.
  ...
  private:
    ...
    // Looks for a loop in the BEC instance with a segment named fluidSegmentName
    ...
    // Retruns the ServiceHotWater loop in the BEC instance with a segment named fluidSegmentName
    // If the loop is not found in the model, this function will attempt to translate it out of the BEC.
