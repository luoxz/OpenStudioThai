...
namespace bec {
  ...
  public:
    ...
    void processPlantLoop(QDomElement &CentralACList, QDomElement &CentralACDetail, model::PlantLoop *plantLoop, QString customListName=QString());
