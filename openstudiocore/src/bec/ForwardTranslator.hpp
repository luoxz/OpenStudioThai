...
namespace bec {
  ...
  public:
    ...
    /** Get warning messages generated by the last translation.  
      * Warnings are issues encountered during translation that are important, but not fatal to producing a valid BEC for compliance analysis*/
    std::vector<LogMessage> warnings() const;

    /** Get error messages generated by the last translation.
      * Errors are issues encountered during translation that are fatal to producing a valid BEC for compliance analysis*/
  ...
  private:
    ...
    // and the caller (modelToBEC) should catch the exception and report the log up to that point.
